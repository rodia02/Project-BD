...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2023 at 09:48 AM
...
INSERT INTO `barang` (`id_produk`, `rincian_barang`, `jenis_barang`, `taksiran`, `id_pegawai`) VALUES
(1, 'laptop lenovo legion', 'Elektronik', 1400000, 19001);
...
INSERT INTO `karyawan` (`id_pegawai`, `no_hp`, `gaji`, `nik`, `nama`, `password`, `alamat`, `jenis_kelamin`) VALUES
(19001, '087805141217', 3000000, '12214', 'user1', '12345', 'Medan', 'Perempuan');
...
(23001, 5000000, '2023-03-30', 1, 19001);
...
ALTER TABLE `barang`
  ...
  ADD UNIQUE KEY `index` (`id_pegawai`);
...
--
ALTER TABLE `penggadai`
  MODIFY `id_produk` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `barang_ibfk_1` FOREIGN KEY (`id_pegawai`) REFERENCES `karyawan` (`id_pegawai`) ON DELETE NO ACTION ON UPDATE CASCADE;
