...
//$karyawan = select("SELECT * FROM karyawan ORDER BY id_pegawai = $id_pegawai")[0];
...
if (isset($_POST['tambah'])) {
    ...
    else if(create_data_penggadai($_POST) > 0){
        echo "<script>
              alert('Data berhasil ditambah!');
              document.location.href = 'data-gadai.php';
             </script>";
    ...
    <div class="row mt-4" style="border: 1px solid grey;">
        <div class="col-sm mt-3" style="padding: 30px 50px">
            ...
            <!--<div class="mb-3">
                ...
                <input class="form-control" id="id_pegawai" name="id_pegawai" type="text" style="width: 60%" 
                value="<?//= $karyawan['id_pegawai']; ?>" required>
            </div>-->
        </div>
  </div>
