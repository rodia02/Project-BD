...
function create_barang($post)
{
    ...
    $query = "INSERT INTO barang VALUES(null, '$rincian_barang', '$jenis_barang', '$taksiran')";
...
function create_transaksi($post)
{
    ...
    $query = "INSERT INTO transaksi VALUES(null, '$jlh_pinjaman', '$tgl_jatuh_tempo', '$id_produk', '$id_pegawai', ' $jenis_transaksi' )";
